              ...
              <div className="flex flex-col justify-center text-left max-w-2xl">
                ...
                <div className="md:hidden">
                  <p className="text-sm leading-relaxed text-ink">
                    {bioOpen
                      ? bioFull
                      : "Formada en el Conservatorio de Música de Puerto Rico, maestra de los métodos Suzuki, Dalcroze, Orff Schulwerk, Kindermusik…"}
                  </p>
                  {moreBtn(bioOpen, () => setBioOpen((v) => !v))}

                  <div className="rounded-2xl bg-ink px-5 py-4 mt-2">
