        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              { icon: Music, secondaryIcon: Palette, title: 'Música y Arte', desc: 'Despertamos la imaginación, la expresión, la sensibilidad estética a través del arte, la música y el baile.', color: 'text-accent', bg: 'bg-accent/20', hoverBorder: 'hover:border-accent/60', popupImages: [metodologiaMusic, metodologiaArt], popupBg: '#FFF3EA' },
