    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="sobre" className="bg-muted py-20">
        <div className="container text-center max-w-5xl mb-14">
          ...
          <h2 className="text-4xl sm:text-5xl text-ink mt-6 mb-5" style={{ fontFamily: "'ChildsPlayground', cursive" }}>Somos un centro educativo que ofrece un innovador programa de educación infantil, donde cada niño es tratado como lo que es: único e irrepetible.</h2>
        </div>
        ...
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              { icon: Activity, title: 'Física', desc: 'Se refuerzan los patrones básicos de movimiento con ejercicios programados de diversos tipos. Los niños efectúan ejercicios de psicomotricidad, en un ambiente diseñado para este fin. Esto contribuye a conseguir una buena maduración neuronal, una correcta lateralización y un buen dominio espacial.', color: 'text-leaf', bg: 'bg-leaf/10', hoverBorder: 'hover:border-leaf/50' },
