        ...
        <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-2">
            ...
            <a
              ...
              className="group block"
            >
              <Card className="p-6 rounded-2xl border-2 hover:border-azure hover:shadow-soft transition-all h-full">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-azure/15 text-azure mb-4">
